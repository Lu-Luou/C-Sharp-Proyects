...
namespace Administracion_Sanatorio
{
    public static class BaseDeDatos
    {
        ...
        {
            new Paciente { DocumentoIdentidad = "12345678", Nombre = "Carlos", Apellido = "López", Telefono = "123456789", ObraSocial = true, MontoCobertura = 5000 },
            ...
            new Paciente { DocumentoIdentidad = "45678912", Nombre = "Lucía", Apellido = "García", Telefono = "456789123", ObraSocial = true, MontoCobertura = 3000 }
        };

        // Arreglo de Intervenciones Quirúrgicas
        public static Intervencion[] Intervenciones = new Intervencion[]
        {
            new IntervencionAltaComplejidad { Codigo = "INT001", Descripcion = "Bypass coronario", Especialidad = "Cardiología", Arancel = 20000, PorcentajeAdicional = 15 },
            new Intervencion { Codigo = "INT002", Descripcion = "Reparación de fractura", Especialidad = "Traumatología", Arancel = 8000 },
            new IntervencionAltaComplejidad { Codigo = "INT003", Descripcion = "Apendicectomía", Especialidad = "Cirugía General", Arancel = 10000, PorcentajeAdicional = 10 }
        };
    }
}